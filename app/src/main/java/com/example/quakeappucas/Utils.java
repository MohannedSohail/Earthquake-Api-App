...
public class Utils {
    ...
    public static ArrayList<Earthquake> getPlacesNames() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                JSONObject currentPlaceObject = features.getJSONObject(i);

                JSONObject properties = currentPlaceObject.getJSONObject("properties");
